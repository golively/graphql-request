                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (response.ok && !result.errors && result.data) {
                            ...
                            errorResult = typeof result === 'string' ? { error: result } : result;
                            throw new ClientError(__assign(__assign({}, errorResult), { status: response.status }), { query: resolvedDoc, variables: variables });
                        }
                        return [2 /*return*/];
                }
            });
 ...
 * ```
 */
export function request(url, document, variables) {
    return __awaiter(this, void 0, void 0, function () {
        var client;
        return __generator(this, function (_a) {
            client = new GraphQLClient(url);
